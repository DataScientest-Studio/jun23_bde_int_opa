...
class KrakenOrderManager:
    ...
    def _create_data_payload(self, ordertype, pair, volume, price):
        """
        Create the data payload for the API request.

        Parameters:
            ordertype (str): The type of order to place ('limit', 'market', etc.).
        ...
        data = {
            ...
            "ordertype": ordertype,
            "type": "buy" if ordertype == "buy" else "sell",  # Determine whether it's a buy or sell order
    ...
    def place_buy_order(self, pair, volume, price):
        ...
        data = self._create_data_payload("limit", pair, volume, price)
